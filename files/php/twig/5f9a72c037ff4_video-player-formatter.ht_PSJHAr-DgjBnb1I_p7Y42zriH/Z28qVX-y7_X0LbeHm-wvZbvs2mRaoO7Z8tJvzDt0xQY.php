...
class __TwigTemplate_2020d8da0ec7755f62abc7cdc6a4430aafcee1f0edbdff95337e09bec8124636 extends \Twig\Template
{
...
<video preload=\"{{ player_attributes.preload }}\" {{ player_attributes.controls ? 'controls' : '' }} style=\"width:{{ player_attributes.width }}px;height:{{ player_attributes.height }}px;\" {{ player_attributes.autoplay ? 'autoplay' : '' }} {{ player_attributes.loop ? 'loop' : '' }} {{ player_attributes.muted ? 'muted' : '' }}>
  {% for user in items %}
    <source src=\"{{ user }}\"/>
  {% endfor %}
</video>", "modules/contrib/video/templates/video-player-formatter.html.twig", "/opt/lampp/htdocs/riboville-drupal-8/modules/contrib/video/templates/video-player-formatter.html.twig");
    }
}
