...
/* themes/contrib/yg_hotel/templates/block--views-block--homepage-block-1.html.twig */
class __TwigTemplate_5b599f8fdc9a2125610b7a93d444e6e1461d752365bc297d1a935c18cc853095 extends \Twig\Template
{
...
\t<div class=\"scroll-img\" style=\"background-image: url(img/Riboville.jpg);\">&nbsp;</div>
\t</div>
...
\t\t\t<div class=\"explore-btn wow fadeInUp\" data-wow-delay=\"0.9s\"><a class=\"btn btn-info\" href=\"#\">EXPLORE US</a></div>
\t\t\t
\t\t</div>
\t<div class=\"section clearfix\">&nbsp;</div>
\t<div class=\"col-md-12 img-slice-wrap mt-5 mb-5 over-hide\">
\t\t<div class=\"scroll-img\" style=\"background-image: url(img/dining.jpg);\"><div class=\"text_box maialino skrollable              rendered \" data-10000=\"top: 100%;\" data-10500=\"top: -75%;\" style=\"top: 19.85%;\">
\t\t\t<div class=\"top_border\"></div>
\t\t\t<div class=\"center\">
\t\t\t<div class=\"content\">
\t\t\t<header>
\t\t\t<h1>
\t\t\t<span class=\"cream\">Resturant</span>
\t\t\t</h1>
\t\t\t<h2 class=\"cream\">
\t\t\tA Roman holiday in Manhattan
\t\t\t</h2>
\t\t\t</header>
\t\t\t<p>
\t\t\t<span class=\"drop_cap cream\">T</span>
\t\t\this renowned Italian eatery is known for its Roast Suckling Pig, authentic pastas, and flavorful dishes that boast seasonal ingredients from nearby greenmarkets. Decorated in the style of a traditional Roman trattoria, with its rustic oak panels and tiled floors, the restaurant features large windows framing views of Gramercy Park.
\t\t\t</p>
\t\t\t</div>
\t\t\t</div>
...
\t";
    ...
    {
        return "themes/contrib/yg_hotel/templates/block--views-block--homepage-block-1.html.twig";
    }
 ...
 */
#}
<div class=\"col-md-12 text-center wow fadeInUp\" data-wow-delay=\"0.3s\" style=\"visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp; font-size: 24px; padding-left:20%; padding-right:20%; margin-bottom:150px;\">
\t<p >With an instinctual eye for excellence, this new five-star stable is not only about betting on a good business horse – it is something symbolic to the spirit of the family and a soul of success and the stamina it takes to transform intangible luck into a true fortune.
...
\t<div class=\"cursor3\" id=\"cursor3\">&nbsp;</div>
\t</div>
\t", "themes/contrib/yg_hotel/templates/block--views-block--homepage-block-1.html.twig", "/opt/lampp/htdocs/riboville-drupal-8/themes/contrib/yg_hotel/templates/block--views-block--homepage-block-1.html.twig");
    }
}
